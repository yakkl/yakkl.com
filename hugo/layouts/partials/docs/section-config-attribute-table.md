...
| `label` | Text to display in Yakkl menu | String | N/A |
...
| `new_doc_ext` | File extension for new documents created in this section | String | Value of **New File Format** in Yakkl Settings |
