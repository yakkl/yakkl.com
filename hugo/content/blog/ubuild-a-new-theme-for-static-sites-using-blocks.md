...
description: |-
  In April we announced a feature that we believed was a game-changer for static site content managers. Blocks was here to introduce a way for you to put together sites using pre-composed site snippets inside Yakkl.
...
---
Back in April [we announced a feature](https://yakkl.com/blog/blocks-give-your-editors-the-power-to-build-pages/) that we believed was a game-changer for static site content managers. [Blocks](https://yakkl.com/blog/sawmill-layout-composer-for-hugo-and-yakkl/#/) was here to introduce a way for you to put together sites using pre-composed site snippets inside Yakkl.
...
[Take a look at our live demo](https://yakkl.github.io/ubuild-jekyll/) to get a feel for what your pages will look like!

## Quick Start

1. [Fork the repo](https://github.com/yakkl/ubuild-jekyll) and import the site into Yakkl (or click on the Import Button below).
2. Click on 'Add New' in Yakkl and select the Page-Builder template.
...
You can use the button below to automatically copy the `ubuild-jekyll` repo to your Git provider of choice, and immediately import the site to your Yakkl dashboard.

<div id="import-ubuild-theme-button" data-proofer-ignore>
{{% create_site_button
repo="https://github.com/yakkl/ubuild-jekyll.git"
engineName="jekyll"
engineVersion="3.6.0"
...
We built this theme to work out-of-the-box with or without Yakkl. All content is controlled through Front Matter: as we mentioned in our previous article about Blocks, [building the entire page from front matter](https://yakkl.com/blog/sawmill-layout-composer-for-hugo-and-yakkl/#3-making-front-matter-modular) allows us to take a modular approach to our theme. Each component is completely self-contained and configured via Blocks.
...
The `template` variable is automatically added by Yakkl when you're using Blocks. This variable contains the name of the Front Matter Template used to construct the block. We are also introducing a variable called `block`, which we add to our Front Matter Templates as a hidden field. We will use this value to identify which template to include.
...
As we figured out in the previous section, defining and adding Front Matter is all that is necessary to add and customize Blocks. Since Yakkl offers a UI to manage Front Matter, we can use the uBuild theme and any Blocks implementation without having to look at the code. Yakkl uses [Front Matter Templates](https://yakkl.com/docs/settings/front-matter-templates/), a powerful tool that works like a blueprint for Front Matter of all the different types of content you have across your site.

{{% tip %}}
Since uBuild is already set up for Yakkl, all you need to do to get started is to <a href="https://yakkl.com/quick-start?repo=yakkl/ubuild-jekyll&engine=jekyll" data-proofer-ignore>import the theme into your Yakkl dashboard.</a>
{{% /tip %}}

Once the layout and styling for a Block is created, it can be added and customized in Yakkl. You simply need to create a Front Matter Template for each Block and set the `is Partial` toggle to true.
...
{{% tip %}}
Front Matter Templates can also be set in `.yml` files inside the `.yakkl.com` directory.
{{% /tip %}}

In our last step we need to make sure that there is one Front Matter Template that knows about all the different Partials. For this purpose Yakkl offers the Field called Blocks.
...
We think an open-source theme is a great start but we'd like to know your thoughts to make it even better. As we add Blocks to this theme and look for ways to improve the Blocks feature we'd love to have your [feedback, ideas and contributions](https://github.com/yakkl/ubuild-jekyll/issues).

We believe awesome stuff can be built with Blocks, and plan to explore this more in the future. In the meantime, we'd love for you to share with the community what you've built using Yakkl Blocks. [Join our community Slack](https://join.slack.com/t/yakkl/shared_invite/enQtNzEzNzYwNzg0NjQyLWRiNjM5Y2NiMzcxOTgxNzg4OTA3ZjRiZDFlMmY5ZmRjZGUyMGM3ZDc0ZTg5NWMwMmIyNjIzMGE4OTIyZDY5NDM) or tag us on Twitter ([@yakklofficial](https://twitter.com/yakkl)) to let us know!

<div style="margin-top: 2em; padding: 20px 40px;background: #f7f7f7;"><h2>Join us every Friday :date:</h2><p><a href="/categories/frontend-friday/">Frontend Friday</a> is a weekly series where we write in-depth posts about modern web development.</p><p><strong>Next week:</strong> We'll show you <a href="https://yakkl.com/blog/3-tips-for-mastering-blocks/">some tips for using blocks.</a></p><p><strong>Last week:</strong> We looked at ways to <a href="https://yakkl.com/blog/5-ways-to-handle-forms-on-your-static-site/">handle forms on your static site.</a></p></div>
