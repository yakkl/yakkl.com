...
This is the command you will want to [run in your CI environment](https://yakkl.com/blog/automate-deploy-w-circle-ci/) to build your static site before deploying. It will build production assets and also run the static site generator.
...
![](/uploads/2018/04/create-static-site-yakkl-import.png)

When importing a site created with _Create Static Site_ to Yakkl, you will need to tell it that your SSG files are in the `site/` subdirectory. After you select the repo and branch, Yakkl will prompt you for the _config path_. Enter `site` in this field, and Yakkl should then be able to locate your site.
{{% /tip %}}
...
### Configuring Yakkl's Uploads Directory

![](/uploads/2018/04/create-static-site-yakkl-upload-paths.png)

After importing your site to Yakkl, go to _Settings_ and configure your upload paths in the _File Paths_ section. To take advantage of _Create Static Site_'s image optimization for your uploads, ensure your upload folder begins with `/src/img/` and your file URLs start with `/img/`.
...
{{% tip %}}
Is there something missing from _Create Static Site_ that is essential to your workflow? Consider [forking the repository](https://github.com/yakkl/create-static-site) to create a new flavor, or [posting an issue](https://github.com/yakkl/create-static-site/issues) if you think it would be a sensible default.
{{% /tip %}}
...
If you'd like to contribute, [check out the contribution guidelines](https://github.com/yakkl/create-static-site/blob/master/CONTRIBUTING.md) and take a look at the [issues that are actively seeking contributions](https://github.com/yakkl/create-static-site/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22).

<div style="margin-top: 2em; padding: 20px 40px;background: #f7f7f7;"><h2>Join us every Friday :date:</h2><p><a href="/categories/frontend-friday/">Frontend Friday</a> is a weekly series where we write in-depth posts about modern web development.</p><p><strong>Next week:</strong> We'll explore how to automatically publish scheduled posts for your static site</p><p><strong>Last week:</strong> We introduced Blocks and Sawmill, a Hugo Theme that empowers your Editors to <a href="https://yakkl.com/blog/sawmill-layout-composer-for-hugo-and-yakkl/#/">build their own pages</a> while keeping a clean code.</p></div>
