---
title: 'Sawmill: A Razor-sharp Layout Composer for Hugo and Yakkl'
description: ''
...
To make it easy to manage these sections, Sawmill was created to work with Yakkl's CMS straight out of the box via its included Yakkl configuration files. This theme is being released in tandem with Yakkl's new [Blocks](https://yakkl.com/blog/content-blocks-give-your-editors-the-power-to-built-pages/) feature and takes full advantage of this new field type for its page builder.
...
linkText="Create a New Sawmill Site in Yakkl" %}}
</div>
...
{{% tip %}}
Yakkl.com’s CMS is all about manipulating front matter. Yakkl allows you to create **front matter templates** that define a set of fields and their type that are used to configure the CMS interface.
{{% /tip %}}
...
Sawmill includes a handful of components for building dynamic landing pages, and is packaged with Yakkl configuration files so your front matter templates are already configured. Select the **Page** front matter template when creating a page in Yakkl in order to use this layout builder.

### Yakkl Blocks

Yakkl has a type of front matter field designed for the express purpose of creating modular content sections like this. We call it [Blocks](https://yakkl.com/blog/content-blocks-give-your-editors-the-power-to-built-pages/).

![Yakkl blocks template selector](/uploads/2018/04/blocks-field-templates.png)
...
<a href="https://app.yakkl.com/quick-start?repo=dwalkr/sawmill-starter&engine=hugo" class="create-site-button" data-proofer-ignore>Create a New Sawmill Site in Yakkl</a>
</div>

<div style="margin-top: 2em; padding: 20px 40px;background: #f7f7f7;"><h2>Join us every Friday 📅</h2><p><a href="/categories/frontend-friday/">Frontend Friday</a> is a weekly series where we write in-depth posts about modern web development.</p><p><strong>Next week:</strong>We'll show you one way to <a href="https://yakkl.com/blog/automatically-publish-scheduled-posts-for-static-site/">automatically publish scheduled posts for a static site.</a> </p><p><strong>Last week:</strong> We showed you how to <a href="https://yakkl.com/blog/build-a-json-api-with-hugo">build a JSON API with Hugo.</a></p></div>