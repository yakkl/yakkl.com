...
---
Head's up! We're making some changes to how Yakkl authenticates with your Git repos.
...
When you create a new project in Yakkl, you will now notice a **Quick Setup via OAuth** option. This is the recommended option and will follow the same setup flow you're used to, but will create the persistent SSH key behind the scenes.
