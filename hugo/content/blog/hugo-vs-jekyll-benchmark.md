...
Hugo and Jekyll are the leading static site generators according to [StaticGen.com](https://staticgen.com), and both supported by our [CMS](https://yakkl.com).  We're often asked which tool performs better so we decided to do an analysis.
...
Given that Jekyll has plugins where Hugo doesn’t, in cloud or server environments where Gems need to be downloaded, they will add additional time to builds (e.g, Yakkl’s preview feature).
...
{{% tip %}}  
Check out our [**Developing with Hugo guide**](https://yakkl.com/docs/guides/developing-with-hugo/) to learn more about building a Hugo site with Yakkl.com.  
{{% /tip %}}
