...
{{% tip "What is Algolia?" %}}
If you’re not familiar with Algolia’s search service, [check out our blog post on the subject](https://yakkl.com/blog/search-with-algolia-in-jekyll/).
{{% /tip %}}
...
By the way, you can totally edit your VuePress site in Yakkl now! 🎉

![](/uploads/2018/08/add-site-vuepress.png)

To do so, import a new site and select **VuePress** as the engine. After the site imports, you will need to configure your content sections. Navigate to the **Settings** section and click the **Sidebar** tab. Follow the instructions in the [sidebar documentation](https://yakkl.com/docs/settings/content-sections/) to tell Yakkl which content files you want to be able to edit.

For my project, I’ve elected to keep all the documentation in a `docs/` folder while still using the `README.md` file at the root of the project to provide a project overview. To configure this in Yakkl, I’m going to create two sections:
...
VuePress support is a new feature in Yakkl and currently comes with some constraints. You can’t preview your pages, and Yakkl can’t build and deploy the site for you. This is why I’ve elected to use Netlify to handle the deployment and hosting.

## VuePress and Beyond

You may have noticed that there isn’t much special about the `serverless-autopublish` project that identifies it as a VuePress site. To use it with Yakkl, I just had to tell it where my markdown files were. VuePress adapts well to existing markdown documentation, and Yakkl can be used to edit a VuePress site, so it stands to reason that Yakkl could be used effectively to edit markdown docs for anything. Our release of VuePress support is just the first steps on a path of supporting a wide variety of content publishing tools!

<div style="margin-top: 2em; padding: 20px 40px;background: #f7f7f7;"><h2>Join us every Friday :date:</h2><p><a href="/categories/frontend-friday/">Frontend Friday</a> is a weekly series where we write in-depth posts about modern web development.</p><p><strong>Next week:</strong> We'll explore some <a href="https://yakkl.com/blog/data-relationships-in-hugo/">advanced data relationships in Hugo</a>. </p><p><strong>Last week:</strong> We showed you <a href="https://yakkl.com/blog/creating-a-multilingual-blog-with-jekyll/">how to create a multilingual blog in Jekyll.</a></p></div>
