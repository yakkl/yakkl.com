...
You can allow Yakkl to migrate Data files for you or choose to make this configuration yourself.  
...
Click on the link and **Start Migration**. Once Yakkl finishes loading you'll see your new Data Files section in the Sidebar.
...
Yakkl adds new sections to the top of the list. If that's not the correct order for your site you can simply reorganize Headings and Sections via Drag-and-Drop.
