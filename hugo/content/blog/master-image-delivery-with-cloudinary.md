...
In this article, I will show you how to use Cloudinary's image transformations with a Hugo site to create responsive image sets. We will also be using Yakkl as our static content manager, taking advantage of Yakkl's [media library integration for Cloudinary](https://yakkl.com/blog/cloudinary-integration/) to easily upload and manage Cloudinary assets.
...
To demonstrate how to do this, I’ve taken the [demo site](https://github.com/dwalkr/snipcart-hugo-demo) we created for our [Snipcart tutorial](https://yakkl.com/blog/snipcart-brings-ecommerce-static-site/#/) and moved the product images to Cloudinary using Yakkl’s Cloudinary integration.

{{% tip %}}
Check out [Yakkl's Cloudinary docs](https://yakkl.com/docs/media/cloudinary/) for information on getting started with Cloudinary in Yakkl's content manager.
{{% /tip %}}

### Building Cloudinary URLs

When Yakkl saves a Cloudinary image to front matter, it only saves a part of the file URL, relative to your base Cloudinary URL. This is a deliberate decision to make it easy to insert image transformations in the URL path, in between your base URL and the file path.
...
When you're ready to connect your Yakkl media library to Cloudinary, check out our [Cloudinary documentation](https://yakkl.com/docs/media/cloudinary/) to get started!

<div style="margin-top: 2em; padding: 20px 40px;background: #f7f7f7;"><h2>Join us every Friday :date:</h2><p><a href="/categories/frontend-friday/">Frontend Friday</a> is a weekly series where we write in-depth posts about modern web development.</p><p><strong>Next week:</strong> We'll look at <a href="https://yakkl.com/blog/for-static-sites-theres-no-excuse-not-to-use-a-cdn/"> the advantages of hosting your static site on a CDN.</a> </p><p><strong>Last week:</strong> We added some enhancements to our <a href="https://yakkl.com/blog/hugo-json-api-part-2/">Hugo JSON API</a>.</p></div>
