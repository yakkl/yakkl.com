...
Support for Static Site Generators (SSGs), beyond Jekyll and Hugo, was on our roadmap for a while now. In fact, Jordan mentioned adding other SSGs to Yakkl back when our first beta was [leaked on Producthunt](https://www.producthunt.com/posts/yakkl#comment-320289) two years ago.

_Why did you make us wait?_ We love to create a great content management experience and make an app that is as easy-to-use for developers as it is for editors. That's why until now other features (e.g. [blocks](https://yakkl.com/blog/blocks-give-your-editors-the-power-to-build-pages/), [cloudinary integration](https://yakkl.com/blog/cloudinary-integration/) or [editing in teams](https://yakkl.com/blog/renaming-files-and-improving-team-editing/)) were given priority.
...
{{% create_site_button
repo="https://github.com/yakkl/portfolio-vuepress.git"
engineName="vuepress"
engineVersion="0.12.0"
heading="You don't have a VuePress Project?"
linkText="Add Yakkl's VuePress Portfolio Theme" %}}
</div>

See the repo [here](https://github.com/yakkl/portfolio-vuepress)
...
After your import, we'll ask you to configure your sidebar. Simply go to `Settings` and select the `Sidebar` tab. Check out the [docs](https://yakkl.com/docs/settings/content-sections/) for more information.

![](/uploads/2018/08/docs-configuration.png)

{{% tip %}}

You can reset previous configurations by removing `.yakkl/settings.yml` and reimporting your site under `Settings` selecting the `Repository` tab.
...
We also made a few other changes. Now, you can create custom headings in your content sections and add single files to your sidebar. Read more in the [docs](https://yakkl.com/docs/settings/content-sections#type)

![](/uploads/2018/08/sidebar-headings-1.png)

You can check out a full list of changes, bug fixes and upgrades in our [changelogs](https://yakkl.com/docs/changelog/).
