...
---
I love automation. If you’ve been following this blog, you’ll know I’ve written [a few times](https://yakkl.com/blog/5-options-for-automating-your-software-deployments/) about using [continuous integration](https://yakkl.com/blog/automate-deploy-w-circle-ci/) to automate the deployment of your software. Why stop at deployment? Can we use automation to improve our infrastructure?
...
[View the complete template on GitHub](https://github.com/yakkl/cloudformation-templates/blob/35179ceaa0d0b12a5e4560fe69f774adcca6f875/static-site-hosting/basic-s3-cloudfront.yml), or
...
Be sure to check out the [full template on GitHub](https://github.com/yakkl/cloudformation-templates/blob/35179ceaa0d0b12a5e4560fe69f774adcca6f875/static-site-hosting/basic-s3-cloudfront.yml#L58) to see the `DefaultCacheBehavior` configuration - it has been excluded here for brevity.
...
<div style="margin-top: 2em; padding: 20px 40px;background: #f7f7f7;">
    ...
    <p><strong>Last week:</strong> We gave you some tips on creating <a href="https://yakkl.com/blog/create-in-app-documentation-for-content-editors/">in-app documentation in Yakkl.</a></p>
</div>
