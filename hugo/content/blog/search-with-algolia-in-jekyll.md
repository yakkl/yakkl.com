...
Algolia's self-proclaimed claim-to-fame is that they are _"the most reliable platform for building search into your business,"_ and honestly, it's hard to disagree. Yakkl's search is powered by Algolia _(just try searching for Algolia in the search above!)._
...
Having to run the NPM script manually each time your site changes isn't ideal, especially when using services like Yakkl.
...
This only applies when using GitHub pages to build your site. If you're using Yakkl or another third-party services to build your site and commit it back to the `gh-pages` branch, you will need to use their webhook features to trigger your function.
...
<p><strong>Next week:</strong> We'll write about <a href="https://yakkl.com/blog/search-with-algolia-in-hugo/">Algolia search for your Hugo site.</a> Stay tuned!</p>  
<p><strong>Last week:</strong> We measured the build performance of Hugo and Jekyll in <a href="https://yakkl.com/blog/hugo-vs-jekyll-benchmark/">Hugo vs Jekyll: Benchmarked</a>.</p>  
</div>
