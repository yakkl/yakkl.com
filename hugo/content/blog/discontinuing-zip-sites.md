...
At Yakkl, we believe Git-backed content management systems are the future of content management, and that using a Git repository is the best way to manage sites.
...
Once you have a backup of your site, you just need to setup a repo, add the backup, and import it into Yakkl and you’re all set!
...
**Step Two: Add A New Site in Yakkl**
...
4. Now, choose your repository, and the branch your source code is in — usually master — and then click “Next”.  
   ...
   1. _When using Github, you can choose to give Yakkl access to only public repositories, or all private repositories as well. If you’re using a free account, choose public._  
...
6. **You’re all done!**  
   _You can start managing your site once Yakkl has finished processing it and generates your custom-made CMS!_
