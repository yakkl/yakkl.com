...
---
Hugo makes it super easy to build simple APIs with its built-in output formats. In [my previous article](https://yakkl.com/blog/build-a-json-api-with-hugo/), we built a fully functional JSON API.  Today we’re going to extend the capabilities of this API and improve the user experience with better URLs.
...
Missed the first part? Read [Build a JSON API With Hugo's Custom Output Formats](https://yakkl.com/blog/build-a-json-api-with-hugo/)
...
In order to achieve this we’ll have to create a [custom output format](https://yakkl.com/blog/build-a-json-api-with-hugo/#output-formats).
...
Lastly we’ll need to create a template for our output format. In [Part 1](https://yakkl.com/blog/build-a-json-api-with-hugo/) we explained how to name our template files for Hugo to pick them up. It requires the following naming convention:
...
<div style="margin-top: 2em; padding: 20px 40px;background: #f7f7f7;"><h2>Join us every Friday :date:</h2><p><a href="/categories/frontend-friday/">Frontend Friday</a> is a weekly series where we write in-depth posts about modern web development.</p><p><strong>Next week:</strong> We'll take a look at <a href="https://yakkl.com/blog/master-image-delivery-with-cloudinary/">Cloudinary's image transformations.</a> </p><p><strong>Last week:</strong> We showed you how to <a href="https://yakkl.com/blog/snipcart-brings-ecommerce-static-site/">build a static e-commerce site with Snipcart</a>.</p></div>
