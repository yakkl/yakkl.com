---
title: 'Up & Running With Hugo, Part 2: Setting up GitHub & Yakkl (CI & CD)'
...
--- -->
For this week on [_Frontend Friday_](/categories/frontend-friday/ "frontend friday tag")_,_ we have a follow up to [_Up & Running With Hugo, Part 1: Building Your First Site_](/blog/up-and-running-with-hugo/). This week, we cover integrating your repository with GitHub, and setting up continuous integration and continuous deployment with Yakkl.com and some other handy tools.
...
4. [Setting up Continuous Deployment with Yakkl](#4-setting-up-continuous-deployment-with-yakkl)
...
More on CI & CD in our [Frequently Asked Questions](https://yakkl.com/docs/faqs/glossary/ci-cd/).
...
Git is our version control system, which will enable CI & CD through tools like [Yakkl](https://yakkl.com).
...
## 4) Setting up Continuous Deployment with Yakkl

Your final step is to set up continuous deployment with Yakkl, so that each time a commit is pushed to your remote repository,  your site is automatically rebuilt and deployed to your hosting provider!

{{% tip %}}

If you haven't already set up your site in Yakkl, follow our comprehensive [_quick start guide_](https://yakkl.com/docs/quickstart/setup-site/) for importing and setting up a site with Yakkl CMS.
...
**Note:** the _Deploy on Git Push_ feature only works when Yakkl is handling deploying of your site. To learn how to set up deployment with Yakkl, see our [hosting docs](https://yakkl.com/docs/hosting/).
...
We recommend you head over to the [Yakkl docs](https://yakkl.com/docs) to learn how Yakkl can help make managing your static site easier.

### Up next

This concludes our Hugo + Git + Yakkl.com Introduction. Next week DJ is diving deeper into Continuous Integration and Continuous Delivery using CircleCI - a technology we at Yakkl.com are using every day.


<div style="padding: 20px 40px;background: #f7f7f7;">  
<h2>Join us every Friday 📅</h2>  
<p><a href="/categories/frontend-friday/">Frontend Friday</a> is a weekly series where we write in-depth posts about modern web development.</p>  
<p><strong>Next week:</strong> We'll look into Continuous Integration and Continuous Delivery: <a href="https://yakkl.com/blog/automate-deploy-w-circle-ci/">Automate Your Static Site Deployment with CircleCI</a></p>  
<p><strong>Last week:</strong> <a href="https://yakkl.com/blog/up-and-running-with-hugo/">Up & Running With Hugo Part I: Building Your First Site</a>.</p>  
</div>
