...
{{% tip %}}
We’ve chosen to bind to `0.0.0.0:8080` here for compatibility with Yakkl’s [instant previews](https://yakkl.com/docs/previews/instant-previews/).
{{% /tip %}}
...
Now, when we run `npm run develop`, it will start the development server, building both the Webpack assets and the Hugo site in a single sequence. When using the site with Yakkl’s instant previews, you can just set the instant preview command to `npm run develop`.
...
- Makes it easy to work with Yakkl’s Instant Previews
