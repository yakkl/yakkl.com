...
| yakkl.com | 33 ms | 15 ms |

Now, there several factors that affect ping, but here’s the takeaway: we both received a response from `yakkl.com` faster than we received a response from the server in Northern Virginia, despite being on opposite ends of the country.

We can better understand what’s going on here by checking the [PTR record](https://www.cloudns.net/wiki/article/40/) for `yakkl.com`'s IP address. To do this, run the following command:
...
When Chris ran his `ping` command, `yakkl.com` resolved to a different IP address. Running the same command on this IP address, we see `server-52-85-83-253.lax1.r.cloudfront.net`. Once again we can follow AWS’ naming convention to deduce that the `lax` subdomain means that this node is located in Los Angeles.
...
<div style="margin-top: 2em; padding: 20px 40px;background: #f7f7f7;"><h2>Join us every Friday :date:</h2><p><a href="/categories/frontend-friday/">Frontend Friday</a> is a weekly series where we write in-depth posts about modern web development.</p><p><strong>Next week:</strong> We'll show you our favorite solutions for <a href="https://yakkl.com/blog/5-ways-to-handle-forms-on-your-static-site/">handling form submissions with your static site.</a> </p><p><strong>Last week:</strong> We showed you how to use <a href="https://yakkl.com/blog/master-image-delivery-with-cloudinary/">Cloudinary</a> to optimize your image delivery.</p></div>
