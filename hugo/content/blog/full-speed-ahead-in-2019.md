...
* **Gatsby Support**, allowing you to use Yakkl with a “_blazing fast”_ Gatsby frontend.
...
To set up instant previews on your site, head over to our [instant previews documentation](https://yakkl.com/docs/previews/instant-previews/).

Special thanks to all of our beta testers for helping us bring this feature to production!

## Git LFS Media

We believe that there are distinct advantages to storing content in version control, which is [why we created a Git-backed content manager](https://yakkl.com/blog/why-we-created-a-git-backed-content-manager/) in the first place. However, large assets can decrease the performance of Git operations on a system, so keeping images in version control isn’t always a great solution for image-heavy sites. This has been our motivation for integrating our media library with [Cloudinary](https://yakkl.com/docs/media/s3/) and [Amazon S3](https://yakkl.com/docs/media/s3/), and now we’re happy to announce that you can also use Git’s [Large File Storage](https://git-lfs.github.com/) to handle your media files.
...
Check out our [Git LFS guide](https://yakkl.com/blog/versioning-large-files-with-git-lfs/) to learn how to set it up for your project.

### Netlify Large Media

In addition to supporting Git LFS through GitHub and GitLab cloud providers, you can also use [Netlify Large Media](https://www.netlify.com/blog/2019/02/26/manage-your-code-and-assets-together-with-netlify-large-media/) with Yakkl, giving you the benefits of using Git LFS for large files while also enabling you to use Netlify's [image transformations](https://www.netlify.com/docs/image-transformation/).

{{% tip %}}
To use Netlify Large Media in yakkl, change your media settings to **Netlify Large Media** and connect to Netlify from the settings screen.
{{% /tip %}}
...
The hottest static site party of 2019 is happening in New York tomorrow! Yakkl is proud to be a Gold Sponsor of [jamstack_conf_nyc](https://jamstackconf.com/) this year, and we’ll be in New York to hang out and talk about all things JAMstack. We’d love to see you there — be sure to stop by our booth for high fives and a little swag!
