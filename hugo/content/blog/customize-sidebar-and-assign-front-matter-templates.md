...
---
Another week full of new features! While the marketing team launched the Blocks theme [uBuild](https://yakkl.com/blog/ubuild-a-new-theme-for-static-sites-using-blocks/) for Jekyll and Hugo, the development team kept working on new product features.

Making the sidebar configurable was really high up on your wish list and this week we made it happen. Some of you also wanted to limit access to [Front Matter Templates](https://yakkl.com/docs/settings/front-matter-templates/) to specific content sections. You can do that now, too.
...
Read more on these updates in our [docs](https://yakkl.com/docs/settings/config-files#section-collection-options) 📖

You can also check out our [previous update](https://yakkl.com/blog/hugo-support-sorting-for-pages-and-more/) 😍