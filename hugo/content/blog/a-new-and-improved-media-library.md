...
- chris-macrae
images:
- "/uploads/2018/01/yakkl-media-images-2.jpg"
publishDate: 2018-01-10 14:00:00 +0000
expirydate: 2030-01-01 04:00:00 +0000
title: Changes & Improvements to the Media Library
description: Have more control over what media is available in Yakkl + Search &
...
---
We've got great improvements to share with you from Yakkl.com, involving Yakkl’s _Media Library_.
...
Yakkl used to display media from all folders throughout the project. Not all of these folders are useful for your editors, and resulted in theme assets, favicons, and other media being displayed.

For this reason, we now restrict the Media Library to display only the media stored your site's "Upload Directory".

### What does this mean?

For existing sites in Yakkl, the media library will now only show media files that are stored in the "Upload Folder", which can be changed in your Site's Settings.
...
If you have any questions, please reach out to [support@yakkl.com](mailto: support@yakkl.com) or in the #feature-requests channel of [Slack community](https://yakkl.com/blog/post/join-our-slack-community/).
