...
description: Git-based Yakkl CMS works with repositories using Git LFS to version
  large binary files.
...
---
I've written before about [the advantages of keeping content in version control](https://yakkl.com/blog/why-we-created-a-git-backed-content-manager/). A quick recap of the benefits:
...
## Yakkl Now Supports Git LFS

Yakkl is now able to handle files stored in Git LFS correctly, so this is an excellent and simple solution if you want to use the image transformation functionality available in [Hugo](https://gohugo.io/content-management/image-processing/) or [Gatsby](https://www.gatsbyjs.org/packages/gatsby-image/). Since Git LFS works transparently on your repository, if you're already using the default media library setting of **Commit Media to Repository**, you don't need to do anything else to take advantage of Git LFS in Yakkl.