...
For example, we’ve built a [menu plugin](https://github.com/yakkl/jekyll-menus) for Jekyll that allows you to manage menus inside the Yakkl CMS.
...
Check out our [Developing with Jekyll guide](/docs/guides/developing-with-jekyll/) to learn more about building a Jekyll site with Yakkl.com.
...
Check out our [Developing with Hugo guide](/docs/guides/developing-with-hugo/) to learn more about building a Hugo site with Yakkl.com.
...
Whether you prefer Jekyll or Hugo, Yakkl.com provides a rich CMS backend for your project. [Check out our getting started guide](/docs/quickstart/setup-site/) to set up your site with Yakkl.com in minutes!
...
<p><strong>Next week:</strong> <a href="https://yakkl.com/blog/build-a-json-api-with-hugo/">We are going to build a RESTful API with Hugo's Custom Output Formats.</a></p>  
<p><strong>Last week:</strong> <a href="https://yakkl.com/blog/write-better-javascript-with-webpack/">We looked at Webpack and how it can make you write better JavaScript.</a></p>  
</div>
