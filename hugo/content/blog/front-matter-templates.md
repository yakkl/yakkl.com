...
We're building a hackable CMS for Jekyll and Hugo sites. A CMS that allows you to strip out the non-essential clutter from your UI and [Front Matter Templates](https://yakkl.com/docs/setting-up-a-site/front-matter-templates/) are the first step in this direction. This is handy if your pages use a lot of [front](https://jekyllrb.com/docs/frontmatter/) [matter](https://gohugo.io/content/front-matter/) fields.
...
<img src="/uploads/2017/12/front-matter-templates-1.jpg" alt="Yakkl front matter demo" class="wider-than-text">
...
For example, change type from a list of tags to an image gallery. [See full list of available fields](https://yakkl.com/docs/setting-up-a-site/front-matter-templates/#field-types).
...
![/blog/images/color-picker-yakkl.png](/uploads/2017/12/color-picker-yakkl.png)
...
[Front Matter Templates](https://yakkl.com/docs/site-configuration/front-matter-templates/) allow you to customize the presentation of the fields in your CMS.  You can set up a template to be used for a single page or for a collection of pages (posts, projects, etc).  Customize the UI so non-developers aren't confused.
