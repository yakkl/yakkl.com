...
weight: ''
aliases:
- "/blog/image-handling-with-yakkl-s3-and-imgix/"

---
Happy New Year! We're starting into 2019 with an exciting new feature.

Today we can announce support for S3 as an image storage provider for Yakkl. The S3 integration makes it possible to efficiently store, organize and deliver images while keeping the editing experience in Yakkl simple and clean.

![](/uploads/2019/01/Yakkl S3.jpg)

Editors, marketers and writers can continue to use the Yakkl Media Library without even knowing that they are using S3 in the backend. This makes it possible to use drag & drop for uploads and offers previews for their images.
...
Until now our Drag & Drop functionality for Blocks was limited to the desktop version of Yakkl. Now you can use this functionality on your mobile devices as well.
...
As always, if you come across a bug or have any suggestions, let us know on [Twitter](https://twitter.com/yakkl), in-app support or via [email](mailto:support@yakkl.com)