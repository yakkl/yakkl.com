...
{{% tip %}}We created [Sawmill](https://github.com/dwalkr/sawmill) as a Starter-Kit and an [Introduction to Blocks](/blog/sawmill-layout-composer-for-hugo-and-yakkl/) so you can get started right away.{{% /tip %}}
...
We just published a Frontend Friday [article](/blog/sawmill-layout-composer-for-hugo-and-yakkl/) providing an in-depth explanation on how to use blocks and set them up.
