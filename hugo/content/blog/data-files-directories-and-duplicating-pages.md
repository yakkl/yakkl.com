...
Yakkl users can now **create folders** in any content section with `create: all` permissions.
...
To stay on top of the improvements we make to Yakkl, be sure to check our [changelog](https://yakkl.com/docs/changelog/) from time to time!