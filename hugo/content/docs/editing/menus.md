...
Yakkl will automatically display menus found in your site, and allow content editors to manage menu items from existing content in your site, or to external links on the internet.
...
The Menu Manager integrates directly with the [Jekyll Menus plugin](https://github.com/yakkl/jekyll-menus).
