...
To upload media files to the Media Library, navigate to the _Media Library_ page in Yakkl, and follow these instructions:
...
* [Media Storage Options in Yakkl](/docs/media/)
