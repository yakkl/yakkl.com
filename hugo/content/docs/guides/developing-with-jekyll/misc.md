...
## Menus
Jekyll does not have built-in support for menus. Yakkl has built a [Jekyll menus][1] plugin that integrates with the Menu Manager of the CMS.

## Further Reading
- [Jekyll Plugins Reference](https://jekyllrb.com/docs/plugins/)

[1]:	https://github.com/yakkl/jekyll-menus