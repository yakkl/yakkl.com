...
---
There are three unique developer environments when working with a Jekyll site in Yakkl:
...
* **Staging environment** this is the environment Yakkl creates when we generate a preview for you. See [Previews](/docs/editing/previews) for more info.

* **Production environment** this is the environment Yakkl publishes your site to. See [Hosting Options](/docs/hosting) for more info.

In order to make development easier, Yakkl sets the environment variable `JEKYLL_ENV` based on the environment you’re in.
