...
To get started, clone your repository to your desktop. For example:
	...
	git clone https://github.com/yakkl/jekyll-demo.git

Now you can begin working on your site. Any changes made to your site can be committed in Git, and will automatically be synced with your Yakkl CMS.
...
Any changes made to your site must be rezipped and reimported into your Yakkl CMS.

You can do this from your [Yakkl Dashboard][2], by choosing "Re-upload Project" from the site’s dropdown menu (…).
...
If you did change your content files, then you can choose `Update project files & content files` which will update the source code and all of the content in Yakkl.
