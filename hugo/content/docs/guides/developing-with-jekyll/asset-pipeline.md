...
---
If you’re planning on using any preprocessing on your assets (images, CSS, or JS) you’ll need to be careful how you implement this as it affects how Yakkl builds your sites.
...
In order to use external build like Gulp, Grunt, or Webpack with Yakkl's [previewing][1] and [deployment][2], you should configure them as follows:
