...
## How Yakkl Parses Hugo

Based on the example structure above, let’s explain how Yakkl parses your site.

## Content

Yakkl parses the `content/` folder for any applicable content.
