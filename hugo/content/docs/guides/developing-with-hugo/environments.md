...
---
There are three unique developer environments when working with a Hugo site in Yakkl:
...
In order to make development easier, Yakkl sets the environment variable `HUGO_ENV` based on the environment you’re in.
