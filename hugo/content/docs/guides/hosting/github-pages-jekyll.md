...
GitHub can handle building your Jekyll site without the need of Yakkl or a CI tool. GitHub will build your Jekyll site each time a new commit is pushed to GitHub and serve it automatically.
...
Lastly, in Yakkl navigate to the *Settings* page, click the *Hosting* tab, and set the *Connection* option to *Commit to source repo only*.
