...
In order to solve this problem, Yakkl sets the base URL of your site based on the environment your site is built in.

* By default, this is the `baseURL` set in your config file.
* For Yakkl previews, this is set to the preview environments URL.
