...
description: Describes a common error for Jekyll users of Yakkl.com and includes
...
---
#### When I view an error log from Yakkl I see: `Could not locate Gemfile or .bundle/ directory`

## What this error means

Gemfiles include a list of project dependencies and where to find them.  Bundler is a dependency manager for the Ruby programming language that can read Gemfiles, resolve the dependency graph and install those gems.  Jekyll is a ruby application and can use Bundler to manage your project dependencies.  Yakkl requires that your Jekyll projects contain a Gemfile at the root of the repository.

This error message typically means that your Jekyll project doesn't have a Gemfile.  This document will help you to create a Gemfile for your project so that you can use Yakkl to build your project and unlock our powerful Preview and Publish functionality.

Jekyll also allows several methods to specify plugins, including using your project Gemfile.  Yakkl will continue to support all of these options specifically for jekyll plugin dependencies.
...
This can happen when you can have gems installed globally on your machine.  Since Yakkl's architecture builds your sites in the cloud we need a way to specify to the cloud computer what code it needs to successfully build your site.  The Gemfile serves this purpose.
...
If  your site builds and you don't see any errors, your project should also build in Yakkl.  If it still doesn't please contact support and we can help.
...
Going forward, Yakkl recommends that you prepend all your jekyll  commands with `bundle exec` like we have in the example above. That way Yakkl previews and publishes should match the experience you have on your computer when you serve and build with Jekyll.
