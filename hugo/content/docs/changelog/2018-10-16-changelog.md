...
* **Deployment Logs:** Yakkl now collects logs from deployment and makes them available through the Notification UI.
...
* **Site Brand:** The Yakkl Logo inside the CMS now behaves like a link i.e. Ctrl/Cmd+Click will open the Yakkl Dashboard in a new tab.