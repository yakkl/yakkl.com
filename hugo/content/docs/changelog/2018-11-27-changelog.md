...
* **Quick Start:** An image of the template to be imported can now be set for the Yakkl Quick Start.
...
* **Gatsby Support:** We're happy to announce that support for [Gatsby](https://www.gatsbyjs.org "Gatsby") is now in private beta. Checkout the [docs](https://yakkl.com/docs/guides/developing-with-gatsby/ "Yakkl + Gatsby") to learn more.