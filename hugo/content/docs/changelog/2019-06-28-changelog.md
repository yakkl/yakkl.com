...
* **SAML / SSO:** Pro plans can now use SSO to allow their users to log in. [https://yakkl.com/docs/pro/features/single-sign-on/](https://yakkl.com/docs/pro/features/single-sign-on/ "https://yakkl.com/docs/pro/features/single-sign-on/")
