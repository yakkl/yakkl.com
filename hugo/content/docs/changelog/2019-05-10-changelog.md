...
* **Front Matter Templates:** removing/renaming a template via git will now delete the template from Yakkl.
* **Include Field**
...
Do you have ideas about what Yakkl should build next? We'd love to hear them! Checkout the our [public roadmap](https://portal.productboard.com/yakkl/ "Yakkl Roadmap") portal to vote on upcoming features and submit your own request.