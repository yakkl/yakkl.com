...
* **Datafile Sections:** Sections will now import data files (`.json`, `.yaml`, and `.toml`). This is a replacement for the current method of importing datafiles. Visit our [docs](https://yakkl.com/docs/editing/data-files/ "Yakkl.com Datafile Docs") to learn more.
