...
* **Import Azure Devops Repositories:** Yakkl is now supports importing from git repositories hosted on [Azure Devops](https://yakkl.com/docs/git-sync/azure-devops/ "Git Sync: Azure Devops").
