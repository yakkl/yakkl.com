...
* **Default Dates to “Now”:** It is now possible to configure date fields to [**default to the current date**](https://portal.productboard.com/yakkl/c/20-allow-date-fields-to-be-defaulted-to-now) when creating a page.
