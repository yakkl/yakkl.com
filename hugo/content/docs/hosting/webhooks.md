...
Yakkl supports _outgoing webhooks_ to notify third-party applications about events that occur in Yakkl. This allows developers to trigger custom deployments, send out notifications, and much more.
...
Yakkl will make a post to your URL with a JSON payload. For example:
