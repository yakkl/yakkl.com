...
Yakkl supports syncing with static sites stored in Azure DevOps repos.
...
After setting up the key, navigate back to the site settings in Yakkl and click **Re-import from azuredevops**. If the key has been set up correctly, this will initiate an import of your site to Yakkl.
