...
Yakkl allows you to import your static site through Bitbucket repositories. This allows Yakkl to sync any changes made by editors in Yakkl to be comitted back to Bitbucket. This also allows developers to work on your website on their local machine, and have all changes by synced back to Yakkl.
...
After setting up the key, navigate back to the site settings in Yakkl and click **Re-import from Bitbucket**. If the key has been set up correctly, this will initiate an import of your site to Yakkl.
