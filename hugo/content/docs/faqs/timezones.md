---
title: Yakkl Isn't Using My Timezone Setting!
weight: 1
layout: single
...
images:
- "/uploads/2018/10/yakkl-timezones.png"
menu:
  faqs:
    parent: FAQs
    weight: 3
...
---
![You may see a different timezone in your commit than you see in the Yakkl UI.](/uploads/2018/10/yakkl-timezones.png)

**We hear this one a lot, and the confusion is understandable.**

When you edit a date or time in Yakkl, the times you input are based on the timezone reported by **your web browser.** You will see this feedback in the Yakkl UI. For example, if you are in the Eastern time zone during daylight savings, you might see `8:00 AM -0500` as the time zone in the date field, because your current timezone is UTC-5.
...
The upshot of this behavior is that anyone editing content on your Yakkl site will be able to edit dates and times relative to their preferred time zone, but when the content is saved it is all normalized to the same timezone across the entire site.
