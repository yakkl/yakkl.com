---
aliases:
- "/docs/faq/what-changes-will-yakkl-make-to-my-repository/"
title: Why did Yakkl edit my files?
weight: 1
layout: single
...
## Front Matter
Yakkl will remove comments and other formatting from front matter, and will also reorder your fields alphabetically. This is unfortunately unavoidable, as comments and order are not respected in the `YAML` or `TOML` specifications.
...
## Menus
When using Yakkl's [Menus feature](/docs/editing/menus/), any internal page or post that is used in the menu will be updated with the front matter data related to the menu.
