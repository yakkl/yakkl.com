...
This tour will walk you through setting up your first site in Yakkl. It demonstrates the primary features and editing functionality of the CMS.
...
3. A window will open asking you to give Yakkl access to your repositories. _If you are not already logged in, your provider will prompt you for login credentials first._
4. Click "Authorize application" and wait a few seconds for the window to close.
5. Give the new repository a name, or keep the default: `yakkl-demo`
6. Click "Create Site"
7. After a moment you will be redirected to the Yakkl Content Manager (CMS)

Congrats, your first site is being created!

This process may take a couple minutes. Yakkl will create a new repository with your git provider, push a copy of our [Belkirk Jekyll Demo](https://github.com/yakkl-templates/belkirk-jekyll-demo "Belkirk Jekyll Demo Repo") site, and then start the import process. Once the import is complete, the CMS will load in all of your content and you can move on to the next section.

{{% tip %}}

To see where your site is stored you can navigate to your Git Provider ([GitHub](https://github.com), [Gitlab](https://gitlab.com) or [Bitbucket](https://bitbucket.org)) and select the relevant repository (e.g. "yakkl-demo"). For example with GitHub your address would look like this https://<span></span>github.com/USERNAME/REPOSITORY.

![](/uploads/2018/12/github-yakkl-demo.png)
...
In Yakkl, all of your content is sorted into _Sections_ under _Content_ in the sidebar. In the demo, these are _Pages, People, Posts_ and _Projects_.
...
Click the _Save_ button to deploy your site. By default Yakkl saves your changes back to your repository. You can [set up deployment](#deployment) to build and send your site to GitHub Pages, (S)FTP Servers, AWS S3 and [other hosting options](/docs/hosting/).
...
* Customize your Preview by adding [Custom Preview Commands](https://yakkl.com/docs/settings/build-commands/)
...
In Yakkl, Data Files show up in the sidebar with your content files, select _Contact Information_ to pull up the demo site's company information.

Update the _Twitter_ option from "yakkl" to "twitter" or any other handle, and then click <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><g fill="none" fill-rule="evenodd" stroke="currentcolor" stroke-width="1.2"><path d="M12 18c6 0 10-6 10-6s-4-6-10-6-10 6-10 6 4 6 10 6z"></path><circle cx="12" cy="12" r="2"></circle></g></svg> in the top-right corner to preview the website.
...
* Connect the Yakkl Media Library with [Cloudinary](/docs/media/cloudinary/) for optimized image delivery

***

## Deployment

When you hit the Save button, Yakkl will create a commit and push it back to your source repo. If you already have an automated build and deploy process connected to your repository, your site will deploy when content is updated.

Alternatively, Yakkl can handle this process for you. In your deployment settings, you can configure a deployment target that uses SFTP, Amazon S3, or GitHub Pages. Yakkl will then build and deploy your site when you hit the Save button.

Under _Site_ click on _Settings_ and choose _Deployment_. You'll see a dropdown with all of your [deployment options](/docs/hosting/) that can currently be handled by Yakkl. See _Additional Resources_ below to find specific guides for selected deployment methods.
...
* Integrate Yakkl with other providers via [Webhooks](/docs/hosting/webhooks/)
* Customize your [Build Commands](https://yakkl.com/docs/settings/build-commands/) for custom build processes

***

## Team and Collaborators Management

Invite your clients or team members to allow them to update the site with Yakkl.

Editors that only have access to one specific site are called Collaborators in Yakkl. These roles are ideal for non-technical users that maintain a site on a regular basis (e.g. writers, clients or marketers).

External collaborators roles are always free, per site you can add up-to 3 of these roles.

For teams that need more advanced collaborators & teams Yakkl provides [Organizations](/docs/collaboration/organizations/). Organizing editors, developers and admins in [User roles](/docs/settings/collaborators#site-access-levels) makes managing your whole team across multiple sites simple (paid feature).

***

## Next Steps

This tour only covers the basics of what Yakkl offers. Now that you've set up your first site in Yakkl, you can begin exploring all of Yakkl's features at your own pace through this documentation:

### Editing

Yakkl has many more features for content editors:
...
Yakkl offers many features that provide flexibility to developers:
...
* Make your Yakkl theme available for others to use with the [Import Button](https://yakkl.com/docs/import-button/).
