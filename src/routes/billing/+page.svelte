  ...
  <div class="bg-gradient-to-b from-white to-gray-50">
    <div class="mx-auto max-w-7xl px-6 pt-24 lg:px-8">
      <div class="sm:align-center sm:flex sm:flex-col">
        ...
        <p class="mt-5 text-xl text-gray-500 sm:text-center">The YAKKL Chrome Extension is v0.10.1-pre.</p>
        <p class="mt-5 text-xl text-gray-500 sm:text-center">We will be doing our first pre-release drop within the next two weeks.</p>
        <p class="mt-5 text-xl text-gray-500 sm:text-center">If you would like to be added to the notification list then please sign up to be notified <a href="/#newsletter" class="text-blue-700">HERE</a>.</p>
        <p class="mt-5 text-xl text-gray-500 sm:text-center">The count down is on!</p>
