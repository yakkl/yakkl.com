  ...
  <div class="bg-gradient-to-b from-white to-gray-50">
    <div class="mx-auto max-w-7xl px-6 pt-24 lg:px-8">
      <div class="sm:align-center sm:flex sm:flex-col">
        ...
        <p class="mt-5 text-xl text-gray-500 sm:text-center">Google is currently doing a review of YAKKL Chrome Extension v0.9.5. Download of YAKKL Smart Wallet is by invitation only until v1.0.0.  If you would like to be added to the list then please sign up for the newsletter and notification <a href="/#newsletter" class="text-blue-700">HERE</a>. We can't wait to demonstrate the incredible features to everyone!</p>
