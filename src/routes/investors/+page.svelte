      ...
      <div class="mx-auto lg:mx-40 md:mx-20 sm:mx-2">
        ...
        <div class="relative z-10">
          <div class="prose prose-indigo mx-auto text-gray-500 lg:max-w-none">
            ...
            <h3>Roadmap</h3>
            <p>Our first product is the YAKKL Smart Wallet. Over the next year, YAKKL security, advanced NFT features, more powerful AI features, and portfolio features will added. We have been asked "why start with the wallet?". Simple, from experience building and scaling large systems, you start with the most difficult problem first. According to "CZ" from Binace, "the wallet is the most difficult thing to get right." Now, that we started our initial release cycle, we move on to a provider instructure model that can span and scale multiple cloud environments. This helps lower our costs overall and enhance one of our goals of being the provider (wallet and infrastructure) of choice by all dApps. This then opens up even more opportunities that we can't discuss here.</p>
