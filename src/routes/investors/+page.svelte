...
<!-- <Gradient> -->
  ...
  <div class="overflow-hidden bg-gray-50 py-16">
    <div class="w-full mx-auto space-y-8 px-4 sm:px-6 lg:px-8">
      <div class="text-base">
        <h2 class="text-lg font-semibold text-gray-600">Investors</h2>
