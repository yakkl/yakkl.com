  ...
  <div class="bg-gradient-to-b from-white to-gray-50">
    <div class="mx-auto max-w-7xl px-6 pt-24 lg:px-8">
      <div class="sm:align-center sm:flex sm:flex-col">
        ...
        <p class="mt-5 text-xl text-gray-500 sm:text-center">Start exploring crypto for <span class="font-extrabold">FREE</span>! The Premier version is FREE for beta users - Wow! Click on 'Get started today' and download/install your YAKKL® Smart Wallet - Chrome Browser Extension.</p> <!--Business and Enterprise/Institution levels unlock additional features specific for multi-divisional enterprises and global institutions.</p>-->
