...
<Gradient>
  <Header/>
    ...
    <div class="relative w-full px-6 py-10 overflow-hidden md:max-w-3xl md:mx-auto lg:max-w-4xl lg:pt-10 lg:pb-15">
      <div class="mt-8 prose prose-indigo max-w-prose mx-auto prose-sm">
<div class="mt-1 max-w-7xl pl-1 pr-1">
  <!-- <div class=" max-w-md mt-2 mx-auto"> -->
      <div class="mt-3 mr-2 mb-2 w-full h-[680px] text-xs p-2  text-gray-900 border-black dark:border-white dark:text-white overflow-scroll">
        ...
        <p class="mt-1">Notice: YAKKL.com does not collect anything except your email if you elect to join the free email newsletter. If you join the email service then see email data use in <a class="underline" href="https://yakkl.com/legal/privacy">Privacy Policy</a>. YAKKL® may be referenced here as "YAKKL" or "YAKKL.com" or "YAKKL, Inc".</p>
        </blockquote>
        ...
        <p class="mt-2">These Terms govern your access to and use of the products and services we provide through or for YAKKL.com.</p>
        ...
        <p class="mt-2">If you would like to learn about how we handle the data you provide us, please see our <a class="underline" href="https://yakkl.com/legal/privacy">Privacy Policy</a>.</p>
        ...
        <h3 class="mt-1 font-bold">a. YAKKL® Fees (if any)</h3>
        ...
        <p class="mt-2"><strong>Cancelling Automatic Renewal.</strong> You can manage and cancel any Paid Services at the respective Service's website portal.</p>
        ...
        <ul class="mt-1">
          ...
          <li>Will not infringe or misappropriate the intellectual property rights of YAKKL® or any third party;</li>
        ...
        <p class="mt-2">The Agreement doesn't transfer any YAKKL® or third-party intellectual property to you, and all right, title, and interest in and to such property remains (as between YAKKL® and you) solely with YAKKL. YAKKL, and all other trademarks, service marks, graphics, and logos used in connection with our websites or Services are trademarks or registered trademarks of YAKKL/LambdaStack (or LambdaStack's licensors). Other trademarks, service marks, graphics, and logos used in connection with our Services may be the trademarks of other third parties. Using our Services doesn't grant you any right or license to reproduce or otherwise use any LambdaStack/YAKKL® or third-party trademarks.</p>
        ...
        <p class="mt-2">LambdaStack, LLC/YAKKL® may assign its rights under the Agreement without condition. You may only assign your rights under the Agreement with our prior written consent.</p>
