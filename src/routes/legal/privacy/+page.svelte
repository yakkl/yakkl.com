  ...
  <Header/>
    ...
    <div class="relative w-full px-4 sm:px-6 lg:px-8 overflow-hidden mx-auto py-8">
      <div class="mt-8 prose prose-indigo max-w-full mx-auto md:mx-20 lg:mx-40 prose-sm">
        ...
        <blockquote>
        Notice: YAKKL, our opensource Kubernetes Automation product, collects nothing except your email if you elect to join the free email newsletter. If you join the email service then see email data use below. Everything else is for and YAKKL.com.
        </blockquote>

        <p>Your privacy is critically important to us. At YAKKL, Inc., we have a few fundamental principles:</p>
        ...
        <ul>
          <li><strong>Basic account information:</strong> We ask for basic information from you in order to set up your account. For example, we require individuals who sign up for a YAKKL.com account to provide an email address and password, along with a username or name — and that's it. You may provide us with more information — like your address and other information you want to share — but we don't require that information to create a YAKKL.com account.</li>
          <li><strong>Public profile information:</strong> If you have an account with us, we collect the information that you provide for your public profile. For example, if you have a YAKKL.com account, your username is part of that public profile, along with any other information you put into your public profile, like a photo or an “About Me” description. Your public profile information is just that — public — so please keep that in mind when deciding what information you would like to include.</li>
          <li><strong>Payment and contact information:</strong> If you buy something from us we'll collect information to process those payments and contact you. If you buy something from us, you may provide additional personal and payment information like your name, credit card information, and contact information. We also keep a record of the purchases you've made.</li>
          <li><strong>Business Profile:</strong> Some of our products may collect additional information from you as part of creating a user/customer profile.</li>
        ...
        <ul>
          ...
          <li><strong>Usage information:</strong> We collect information about your usage of our Services. For example, if you are using YAKKL we collect information about the actions that site administrators and users perform on a site. We also collect information about what happens when you use our Services (e.g., page views, support document searches atYAKKL.com. We use this information to, for example, provide our Services to you, get insights on how people use our Services so we can make our Services better, and understand and make predictions about user retention.</li>
          ...
          <li><strong>Information from cookies & other technologies:</strong> A cookie is a string of information that a website stores on a visitor's computer, and that the visitor's browser provides to the website each time the visitor returns. Pixel tags (also called web beacons) are small blocks of code placed on websites and emails. YAKKL, Inc. uses cookies and other technologies like pixel tags to help us identify and track visitors, usage, and access preferences for our Services, as well as track and understand email campaign effectiveness and to deliver targeted ads. For more information about our use of cookies and other technologies for tracking, including how you can control the use of cookies, please see our [Cookie Policy](http://yakkl.com/legal/cookie-policy).</li>
        </ul>
        ...
        <ul>
          <li><strong>Third Party Login:</strong> If you create or log in to your YAKKL.com account through another service (like Google) we'll receive associated login information (e.g. a connection token, your username, your email address)</li>
          <li><strong>Social Sharing Services:</strong> If you connect your website or account to a social media service (like Twitter) through our Publicize feature, we'll receive information from that service (e.g., your username, basic profile information, friends list) via the authorization procedures for that service.</li>
        </ul>

        <p>The information we receive depends on which services you use or authorize and what options are available.</p>

        <p>Third-party services may also give us information, like mailing addresses for individuals who are not yet our users (but we hope will be!). We may use this information for marketing purposes.</p>

        <h3>How and Why We Use Information</h3>

        <h4>Purposes for Using Information</h4>

        <p>If you use YAKKL.com we use information about you for the purposes listed below:</p>
        ...
        <ul>
          ...
          <li><strong>To protect our Services, our users, and the public.</strong> For example, by detecting security incidents; detecting and protecting against malicious, deceptive, fraudulent, or illegal activity; fighting spam; complying with our legal obligations; and protecting the rights and property of YAKKL, Inc. and others, which may result in us, for example, declining a transaction or terminating Services.</li>
          ...
          <li><strong>To customize the user experience.</strong> For example, to personalize your experience by serving you relevant notifications and advertisements for our Services or recommending content through our Reader post suggestions.</li>
          <li><strong>To communicate with you.</strong> For example, by emailing you to ask for your feedback, share tips for getting the most out of our products, or keep you up to date on YAKKL, Inc.; texting you to verify your payment; or calling you to share offers and promotions that we think will be of interest to you. If you don't want to hear from us, you can opt out of marketing communications at any time. (If you opt out, we'll still send you important updates relating to your account.)</li>
          <li><strong>To recruit and hire.</strong> For example, by evaluating job applicants and communicating with them.</li>
        </ul>

        <h4>Legal Bases for Collecting and Using Information></h4>

        <p>A note here for those in the European Union about our legal grounds for processing information about you under EU data protection laws, which is that our use of your information is based on the grounds that: (1) The use is necessary in order to fulfill our commitments to you under the applicable terms of service or other agreements with you or is necessary to administer your account — for example, in order to enable access to our website on your device or charge you for a paid plan; or (2) The use is necessary for compliance with a legal obligation; or (3) The use is necessary in order to protect your vital interests or those of another person; or (4) We have a legitimate interest in using your information — for example, to provide and update our Services; to improve our Services so that we can offer you an even better user experience; to safeguard our Services; to communicate with you; to measure, gauge, and improve the effectiveness of our advertising; and to understand our user retention and attrition; to monitor and prevent any problems with our Services; and to personalize your experience; or (5) You have given us your consent — for example before we place certain cookies on your device and access and analyze them later on, as described in our [Cookie Policy](http://yakkl.com/legal/cookie-policy).</p>

        <h4>Sharing Information</h4>

        <h4>How We Share Information</h4>

        <p>We share information about you in limited circumstances, and with appropriate safeguards on your privacy. These are spelled out below, as well as in the section called [Ads and Analytics Services Provided by Others](https://www.lambdastackio.com/legals/privacy/#ads-and-analytics-services-provided-by-others):</p>
        ...
        <ul>
          ...
          <li><strong>Set your browser to reject cookies:</strong> At this time, YAKKL, Inc. does not respond to “do not track” signals across all of our Services. However, you can [usually choose](https://www.lambdastackio.com/legals/cookie-policy/#controlling-cookies) to set your browser to remove or reject browser cookies before using our websites, with the drawback that certain features of our websites may not function properly without the aid of cookies.</li>
          <li><strong>Opt out of our internal analytics program:</strong> You can do this through your user settings. By opting out, you will stop sharing information with our analytics tool about events or actions that happen after the opt-out, while you're logged in to your account. For more information, please see our [Cookie Policy](https://www.lambdastackio.com/legals/cookie-policy/#our-internal-analytics-tool).</li>
        ...
        <p>You can find more information about what we collect and sources of that information in the [Information We Collect section](https://www.lambdastackio.com/legals/privacy/#information-we-collect) above. We collect personal information for the business and commercial purposes described in the [How and Why We Use Information section](https://www.lambdastackio.com/legals/privacy/#how-and-why-we-use-information). And we share this information with the categories of third parties described in the [Sharing Information section](https://www.lambdastackio.com/legals/privacy/#sharing-information). If you are a California resident, you have additional rights under the CCPA, subject to any exemptions provided by the law, including the right to:</p>
