  ...
  <Header/>
    ...
    <div class="relative w-full px-6 py-10 overflow-hidden md:max-w-3xl md:mx-auto lg:max-w-4xl lg:pt-10 lg:pb-15">
      <div class="mt-8 prose prose-slate max-w-prose mx-auto prose-sm">
        ...
        <blockquote>
        Notice: LambdaStack, our opensource Kubernetes Automation product, collects nothing except your email if you elect to join the free email newsletter. If you join the email service then see email data use below. Everything else is for and YAKKL.com.
        </blockquote>

        <p>Your privacy is critically important to us. At LambdaStack, LLC, we have a few fundamental principles:</p>
        ...
        <ul>
          ...
          <li><strong>To protect our Services, our users, and the public.</strong> For example, by detecting security incidents; detecting and protecting against malicious, deceptive, fraudulent, or illegal activity; fighting spam; complying with our legal obligations; and protecting the rights and property of LambdaStack, LLC and others, which may result in us, for example, declining a transaction or terminating Services.</li>
          ...
          <li><strong>To communicate with you.</strong> For example, by emailing you to ask for your feedback, share tips for getting the most out of our products, or keep you up to date on LambdaStack, LLC; texting you to verify your payment; or calling you to share offers and promotions that we think will be of interest to you. If you don't want to hear from us, you can opt out of marketing communications at any time. (If you opt out, we'll still send you important updates relating to your account.)</li>
        ...
        <ul>
          ...
          <li><strong>Set your browser to reject cookies:</strong> At this time, LambdaStack, LLC does not respond to “do not track” signals across all of our Services. However, you can [usually choose](https://www.lambdastackio.com/legals/cookie-policy/#controlling-cookies) to set your browser to remove or reject browser cookies before using our websites, with the drawback that certain features of our websites may not function properly without the aid of cookies.</li>
