...
<Content>
  <PageHeader>
    <span slot="smallTitle">Partnering</span>
    <span slot="largeTitle">Please let us know how we can work together.</span>
  </PageHeader>

  <!-- lg:grid-cols-3 -->
  <div class="grid grid-cols-1 mt-14">
    <!-- Contact information -->
    <div class="relative overflow-hidden py-10 px-6 sm:px-10 xl:p-12 rounded-4xl ring-1 ring-inset ring-black/5 bg-[linear-gradient(115deg,var(--tw-gradient-stops))] from-[#fff1be] from-[28%] via-[#ee87cb] via-[70%] to-[#b060ff] sm:bg-[linear-gradient(145deg,var(--tw-gradient-stops))] text-gray-950">
      ...
      <h3 class="text-lg font-medium ">Partnering Information</h3>
      <p class="mt-6 max-w-3xl text-base text-gray-700">
      ...
      <ol class="ml-5 list-disc text-base text-gray-700">
        <li class="ml-5">Affliate Partner</li>
        <li class="ml-5">Collaboration Partner</li>
      </ol>
      <dl class="mt-8 space-y-6">
        <dt><span class="sr-only">Email</span></dt>
        <dd class="flex text-base text-gray-700">
