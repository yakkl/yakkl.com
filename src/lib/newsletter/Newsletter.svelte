<div id="newsletter" class="block mt-5">
  <section class="container mx-auto px-6">
    <div class="w-full lg:flex items-center">
      ...
      <div id="formEmailSubscribe" class="w-full lg:w-1/2 lg:pl-24">
          ...
          <div id="sib-form-container" class="sib-form-container">
            ...
            <div id="success-message" class="sib-form-message-panel"
              ...
              <div class="sib-form-message-panel__text sib-form-message-panel__text--center">
                ...
                <span class="sib-form-message-panel__inner-text">
                  Your notification subscription has been successful.
                </span>
              </div>
            </div>
            <div></div>
            <div id="sib-container" class="sib-container--large sib-container--vertical"
              ...
              <form id="sib-form" method="POST"
                action="https://5a7173ee.sibforms.com/serve/MUIEAOAM7iT5oTuIkQLpNzd8niPZNzX4DW3bZJ2LDWSpauhnpEpvyvDESKzC9-H7BCG5hNCVTiZzyBbTxOOUmcFeACgaRI0u-1zKpFyL1MJmFkY3OT3sbV1GEnbKCBvDRC3NG25QQvOjMkp8vaNpOJgAHmns-40Z3Pfp4Y0F6nuD5TcpNTnOq7fndq2LYuJ6DFn9vfCj4BdCWCbq"
                    ...
                    <div class="form__entry entry_block">
                      <div class="form__label-row ">
                        ...
                        <div class="g-recaptcha sib-visible-recaptcha" id="sib-captcha"
                          data-sitekey="6LfLsCgfAAAAANPwF-qe-7bi2oR1rRg52b4c5ayW" data-callback="handleCaptchaResponse">
                        </div>
                      </div>
                      <!-- svelte-ignore a11y-label-has-associated-control -->
                      <label class="entry__error entry__error--primary"
