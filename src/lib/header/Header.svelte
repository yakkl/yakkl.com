...
<Navbar let:hidden let:toggle>
  <NavBrand href="/">
    <img
      src="/images/logoBullFav48x48.png"
  ...
  <NavUl {hidden}>
    ...
    <NavLi id="nav-crypto" class="cursor-pointer">Crypto<Icon name="chevron-down-solid" class="w-3 h-3 ml-2 text-white dark:text-white" />
