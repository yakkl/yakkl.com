[![CircleCI](https://circleci.com/gh/yakkl/yakkl.com.svg?style=svg)](https://circleci.com/gh/yakkl/yakkl.com)
...
- Environment variables are provided to your templates, which can be accessed in templates as follows: `{{ getenv "HUGO_ENV" }}`
  ...
  - For Yakkl's in-app preview feature, this is equal to `staging`
